...
class Restormer(nn.Module):
    ...
    def __init__(
        ...
        if pretrained == "denoising":
        ...
        elif "denoising_real" == pretrained:
            self.is_standard_denoising_network(
                in_channels,
                out_channels,
                dim,
        ...
        elif "denoising_gray" == pretrained:
            self.is_standard_denoising_network(
                in_channels,
                out_channels,
                dim,
            ...
            weights_pth_filename = "gaussian_gray_denoising_blind.pth"
        elif "denoising_color" == pretrained:
            self.is_standard_denoising_network(
                in_channels,
                out_channels,
                dim,
        ...
        if last_act == "none":
            ...
            raise ValueError(f"last_act value error, {last_act}")
    ...
    def forward_restormer(self, x):
        ...
        out_dec_level1 = self.last_act(out_dec_level1)

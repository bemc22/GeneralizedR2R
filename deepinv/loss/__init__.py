...
from deepinv.loss.r2r import R2RLoss, R2RPoissonLoss, R2RGammaLoss
from deepinv.loss.sure import SureGaussianLoss, SurePoissonLoss, SurePGLoss, SureGammaLoss
